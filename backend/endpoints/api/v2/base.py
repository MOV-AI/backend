...
from movai_core_shared.exceptions import (AclObjectAlreadyExist, AclObjectDoesNotExist, 
                                          AlreadyExist, DoesNotExist, 
                                          LdapConfigAlreadyExist, LdapConfigDoesNotExist,
                                          RoleAlreadyExist, RoleDoesNotExist,
                                          UserAlreadyExist, UserDoesNotExist,
                                          MovaiException,
...
class RestBaseClass:
    ...
    def __init__(self) -> None:
        ...
        self.scope_classes = {'InternalUser': InternalUser,
    ...
    def check_permissions(self):
        ...
        if not self._user.has_permission(self._scope_name, self._permission):
            error_msg = f"User does not have {self._permission} permission "\
    ...
    def validate_result(self, result: dict):
        ...
        try:
            json_result = json.dumps(result,
                                     default=self.json_serializer_converter)
    ...
    def analyze_error(self, error: Exception, error_msg: str) -> None:
        ...
        elif isinstance(error, (AlreadyExist,
                                UserAlreadyExist,
                                RoleAlreadyExist,
